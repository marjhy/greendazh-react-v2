...
const columns = [
  { id: 'department_area', label: 'Department', minWidth: 170 },
  { id: 'pic', label: 'PIC', minWidth: 100 },
  { id: 'M1', label: 'Jan', minWidth: 50 },
  { id: 'M2', label: 'Feb', minWidth: 50 },
  { id: 'M3', label: 'Mar', minWidth: 50 },
  { id: 'M4', label: 'Apr', minWidth: 50 },
  { id: 'M5', label: 'May', minWidth: 50 },
  { id: 'M6', label: 'Jun', minWidth: 50 },
  { id: 'M7', label: 'Jul', minWidth: 50 },
  { id: 'M8', label: 'Aug', minWidth: 50 },
  { id: 'M9', label: 'Sep', minWidth: 50 },
  { id: 'M10', label: 'Okt', minWidth: 50 },
  { id: 'M11', label: 'Nov', minWidth: 50 },
  { id: 'M12', label: 'Des', minWidth: 50 },
  // {
  //   id: "targetmonth",     label: "Target/Month",     minWidth: 170,      align: "right",    format: (value) => value.toLocaleString("en-US"),
  // },
  // {
