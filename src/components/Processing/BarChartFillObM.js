...
const BarChartFillObM = () => {
  ...
  const [title, setTitle] = useState(
    'OPERATIONAL TIME FLEX 2 BY MONTH ' + value
  );

  // LINE CHART OEE FILLING FLEX 2
  const lineChartFillOeeM = () => {
    ...
    axios
      .get(`http://10.24.7.70:8080/OeeMilAGPLMBc/${value}`)
      .then((res) => {
          ...
          <TextField   
           ...
           id='demo-simple-select-outlined2'
            ...
            onChange={(e) => {
              ...
              setValue(value);
              setTitle('OPERATIONAL TIME FLEX 2 BY MONTH ' + value);
            }}
            variant="outlined"
          /><br/>     
          </Grid> 
