...
const BarChartFillObM = () => {
  ...
  const [title, setTitle] = useState(
    'OPERATIONAL TIME RICOTTA 250 BY MONTH ' + value
  );

  // LINE CHART OEE FILLING RICOTTA 250
  const lineChartFillOeeM = () => {
    ...
    axios
      .get(`http://10.24.7.70:8080/OeeChsAGPLMCc/${value}`)
      .then((res) => {
          ...
          <TextField   
           ...
           id='demo-simple-select-outlined2'
            ...
            onChange={(e) => {
              ...
              setValue(value);
              setTitle('OPERATIONAL TIME RICOTTA 250 BY MONTH ' + value);
            }}
            variant="outlined"
          /><br/>     
          </Grid> 
