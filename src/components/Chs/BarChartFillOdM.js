...
const BarChartFillObM = () => {
  ...
  const [title, setTitle] = useState(
    'OPERATIONAL TIME MOZZA 200 BY MONTH ' + value
  );

  // LINE CHART OEE FILLING MOZZA 200
  const lineChartFillOeeM = () => {
    ...
    axios
      .get(`http://10.24.7.70:8080/OeeChsAGPLMDc/${value}`)
      .then((res) => {
          ...
          <TextField   
           ...
           id='demo-simple-select-outlined2'
            ...
            onChange={(e) => {
              ...
              setValue(value);
              setTitle('OPERATIONAL TIME MOZZA 200 BY MONTH ' + value);
            }}
            variant="outlined"
          /><br/>     
          </Grid> 
