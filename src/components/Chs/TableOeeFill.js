...
//http://localhost:8080/OeeChsPGPL
//const API_HOST2 = "http://10.24.7.70:8080";

//const INVENTORY_API_URL = `${API_HOST}/OeeChsPGPLB`;

const INVENTORY_API_URLDB = `${API_HOST}/OeeChsPGPLB`;
const INVENTORY_API_URLDC = `${API_HOST}/OeeChsPGPLC`;
const INVENTORY_API_URLDD = `${API_HOST}/OeeChsPGPLD`;

const INVENTORY_API_URLWB = `${API_HOST}/OeeChsPGPLWB`;
const INVENTORY_API_URLWC = `${API_HOST}/OeeChsPGPLWC`;
const INVENTORY_API_URLWD = `${API_HOST}/OeeChsPGPLWD`;

const INVENTORY_API_URLMB = `${API_HOST}/OeeChsPGPLMB`;
const INVENTORY_API_URLMC = `${API_HOST}/OeeChsPGPLMC`;
const INVENTORY_API_URLMD = `${API_HOST}/OeeChsPGPLMD`;
  ...
  return (
    <Container className='container'>
      <Paper className={classes.root}>
        <h1>DAILY - OEE CHS - ALL GROUP - MOZZA 1000</h1>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>DAILY - OEE CHS - ALL GROUP - MOZZA 200</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>WEEKLY - OEE CHS - ALL GROUP - MOZZA 1000</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>WEEKLY - OEE CHS - ALL GROUP - RICOTTA 250</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>WEEKLY - OEE CHS - ALL GROUP - MOZZA 200</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>MONTHLY - OEE CHS - ALL GROUP - MOZZA 1000</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>MONTHLY - OEE CHS - ALL GROUP - RICOTTA 250</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>MONTHLY - OEE CHS - ALL GROUP - MOZZA 200</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
