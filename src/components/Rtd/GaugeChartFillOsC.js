...
const GaugeChartFillOs = () => {
  ...
  const chartGau = () => {
    ...
    // let pe = [];
    axios
      .get('http://10.24.7.70:8080/OeeRtdPGPLCc/ranuregulo')
      .then((res) => {
        //console.log(res);
...
export default GaugeChartFillOs;
