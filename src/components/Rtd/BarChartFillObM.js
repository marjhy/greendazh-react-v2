...
const BarChartFillObM = () => {
  ...
  const [title, setTitle] = useState(
    'OPERATIONAL TIME RTD 250/150 BY MONTH ' + value
  );

  // LINE CHART OEE FILLING RTD 250/150
  const lineChartFillOeeM = () => {
    ...
    axios
      .get(`http://10.24.7.70:8080/OeeRtdAGPLMBc/${value}`)
      .then((res) => {
          ...
          <TextField   
           ...
           id='demo-simple-select-outlined2'
            ...
            onChange={(e) => {
              ...
              setValue(value);
              setTitle('OPERATIONAL TIME RTD 250/150 BY MONTH ' + value);
            }}
            variant="outlined"
          /><br/>     
          </Grid> 
