...
const GaugeChartFillOb = () => {
  ...
  const chartGau = () => {
    ...
    // let pe = [];
    axios
      .get('http://10.24.7.70:8080/OeeRtdPGPLCc/ranukumbolo')
      .then((res) => {
        //console.log(res);
  ...
  return (
    <Grid Container alignItems='center' direction='row'>
      ...
      >
        <GaugeChart
          id='gauge-chart-ranukumbolo'
          style={chartStyle}
          animate={false}
          nrOfLevels={420}
          arcsLength={[0.44, 0.02, 0.54]}
...
export default GaugeChartFillOb;
