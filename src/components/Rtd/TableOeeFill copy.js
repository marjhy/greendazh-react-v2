...
//http://localhost:8080/OeeRtdPGPL
//const API_HOST2 = "http://10.24.7.70:8080";

//const INVENTORY_API_URL = `${API_HOST}/OeeRtdPGPLB`;

const INVENTORY_API_URLDB = `${API_HOST}/OeeRtdPGPLB`;
const INVENTORY_API_URLDC = `${API_HOST}/OeeRtdPGPLC`;
const INVENTORY_API_URLDD = `${API_HOST}/OeeRtdPGPLD`;

const INVENTORY_API_URLWB = `${API_HOST}/OeeRtdPGPLWB`;
const INVENTORY_API_URLWC = `${API_HOST}/OeeRtdPGPLWC`;
const INVENTORY_API_URLWD = `${API_HOST}/OeeRtdPGPLWD`;

const INVENTORY_API_URLMB = `${API_HOST}/OeeRtdPGPLMB`;
const INVENTORY_API_URLMC = `${API_HOST}/OeeRtdPGPLMC`;
const INVENTORY_API_URLMD = `${API_HOST}/OeeRtdPGPLMD`;
  ...
  return (
    <Container className='container'>
      <Paper className={classes.root}>
        <h1>DAILY - OEE RTD - ALL GROUP - RTD 250/150</h1>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>DAILY - OEE RTD - ALL GROUP - RTD 125</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>WEEKLY - OEE RTD - ALL GROUP - RTD 250/150</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>WEEKLY - OEE RTD - ALL GROUP - RTD POUCH</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>WEEKLY - OEE RTD - ALL GROUP - RTD 125</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>MONTHLY - OEE RTD - ALL GROUP - RTD 250/150</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>MONTHLY - OEE RTD - ALL GROUP - RTD POUCH</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>MONTHLY - OEE RTD - ALL GROUP - RTD 125</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
