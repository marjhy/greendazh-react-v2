...
const std = process.env.REACT_APP_FIL_STD_PE_C; //89
const std2 = process.env.REACT_APP_FIL_STD_OEE_C; //56
...
const INVENTORY_API_URLDB = `${API_HOST}/OeeFilPGPLCMt`;
...
export default TableOeePeFillMC;
