...
const std = process.env.REACT_APP_FIL_STD_OEE_B;
...
const LineChartFillOb = () => {
  ...
  const lineChartFillOeeM = () => {
    ...
    axios
      .get('http://10.24.7.70:8080/OeeFilPGPLBMt')
      .then((res) => {
        //console.log(res);
  ...
  useEffect(() => {
    ...
    // console.log('FIL_STD_OEE_B2 ', process.env.REACT_APP_FIL_STD_OEE_B);
  }, []);
      ...
      <Container id='wrapper'>
        <Line
          ...
          options={{
            responsive: true,
            title: {
              text: 'OEE MONTHLY FILLING LINE B',
              display: true,
              fontSize: 22,
