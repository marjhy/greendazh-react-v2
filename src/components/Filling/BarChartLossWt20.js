...
const BarChartFillObM = () => {
  ...
  const [title, setTitle] = useState(
    'LOSS PACKAGING GREENFIELDS TBA 200 BY WEEK ' + value
  );
  ...
  const lineChartFillOeeM = () => {
    ...
    .then((res) => {
        for (const dataObj2 of res.data) {
          if (dataObj2['MATERIAL GROUP'] === 'GREENFIELDS TBA 200') {
          ...
          <TextField   
           ...
           id='demo-simple-select-outlined2'
            ...
            onChange={(e) => {
              ...
              setValue(value);
              setTitle('LOSS PACKAGING GREENFIELDS TBA 200 BY WEEK ' + value);
            }}
            variant="outlined"
          /><br/>     
          </Grid> 
