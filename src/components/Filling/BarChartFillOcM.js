...
const BarChartFillObM = () => {
  ...
  const [title, setTitle] = useState(
    'OPERATIONAL TIME LINE C BY MONTH ' + value
  );

  // LINE CHART OEE FILLING LINE C
  const lineChartFillOeeM = () => {
    ...
    axios
      .get(`http://10.24.7.70:8080/OeeFilAGPLMCc/${value}`)
      .then((res) => {
          ...
          <TextField   
           ...
           id='demo-simple-select-outlined2'
            ...
            onChange={(e) => {
              ...
              setValue(value);
              setTitle('OPERATIONAL TIME LINE C BY MONTH ' + value);
            }}
            variant="outlined"
          /><br/>     
          </Grid> 
