...
const BarChartFillObM = () => {
  ...
  const [title, setTitle] = useState(
    'LOSS PACKAGING UHT PACK 1000 ML WC BY WEEK ' + value
  );
  ...
  const lineChartFillOeeM = () => {
    ...
    axios
    .get(`http://10.24.7.70:8080/LossOeeFillW/${value}`)
    .then((res) => {
        for (const dataObj2 of res.data) {
          if (dataObj2['MATERIAL GROUP'] === 'UHT PACK 1000 ML WC') {
          ...
          <TextField   
           ...
           id='demo-simple-select-outlined2'
            ...
            onChange={(e) => {
              ...
              setValue(value);
              setTitle('LOSS PACKAGING UHT PACK 1000 ML WC BY WEEK ' + value);
            }}
            variant="outlined"
          /><br/>     
          </Grid> 
