...
const std = process.env.REACT_APP_FIL_STD_PE_D; //89
const std2 = process.env.REACT_APP_FIL_STD_OEE_D; //56
...
const INVENTORY_API_URLDB = `${API_HOST}/OeeFilPGPLDMt`;
...
export default TableOeePeFillMD;
