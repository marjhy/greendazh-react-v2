...
const std = process.env.REACT_APP_FIL_STD_PE_B; //89
const std2 = process.env.REACT_APP_FIL_STD_OEE_B; //56
...
const INVENTORY_API_URLDB = `${API_HOST}/OeeFilPGPLBMt`;
...
export default TableOeePeFillMB;
