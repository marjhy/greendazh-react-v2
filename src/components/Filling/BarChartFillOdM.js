...
const BarChartFillObM = () => {
  ...
  const [title, setTitle] = useState(
    'OPERATIONAL TIME LINE D BY MONTH ' + value
  );

  // LINE CHART OEE FILLING LINE D
  const lineChartFillOeeM = () => {
    ...
    axios
      .get(`http://10.24.7.70:8080/OeeFilAGPLMDc/${value}`)
      .then((res) => {
          ...
          <TextField   
           ...
           id='demo-simple-select-outlined2'
            ...
            onChange={(e) => {
              ...
              setValue(value);
              setTitle('OPERATIONAL TIME LINE D BY MONTH ' + value);
            }}
            variant="outlined"
          /><br/>     
          </Grid> 
