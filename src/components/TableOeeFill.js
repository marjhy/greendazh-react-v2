...
//http://localhost:8080/OeeFilPGPL
//const API_HOST2 = "http://10.24.7.70:8080";

const INVENTORY_API_URL = `${API_HOST}/OeeFilPGPLB`;

const INVENTORY_API_URLDB = `${API_HOST}/OeeFilPGPLB`;
const INVENTORY_API_URLDC = `${API_HOST}/OeeFilPGPLC`;
const INVENTORY_API_URLDD = `${API_HOST}/OeeFilPGPLD`;

const INVENTORY_API_URLWB = `${API_HOST}/OeeFilPGPLWB`;
const INVENTORY_API_URLWC = `${API_HOST}/OeeFilPGPLWC`;
const INVENTORY_API_URLWD = `${API_HOST}/OeeFilPGPLWD`;

const INVENTORY_API_URLMB = `${API_HOST}/OeeFilPGPLMB`;
const INVENTORY_API_URLMC = `${API_HOST}/OeeFilPGPLMC`;
const INVENTORY_API_URLMD = `${API_HOST}/OeeFilPGPLMD`;
...
const columns = [
  ...
  { id: 'AvailableTime', label: 'Available Time', minWidth: 50 },
  ...
  { id: 'IdealRunningTime', label: 'Ideal Running Time', minWidth: 50 },
  ...
  return (
    <Container className='container'>
      <Paper className={classes.root}>
        <h1>DAILY - OEE FILLING MILK - ALL GROUP - LINE B</h1>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>DAILY - OEE FILLING MILK - ALL GROUP - LINE C</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>DAILY - OEE FILLING MILK - ALL GROUP - LINE D</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>WEEKLY - OEE FILLING MILK - ALL GROUP - LINE B</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>WEEKLY - OEE FILLING MILK - ALL GROUP - LINE C</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>WEEKLY - OEE FILLING MILK - ALL GROUP - LINE D</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>MONTHLY - OEE FILLING MILK - ALL GROUP - LINE B</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>MONTHLY - OEE FILLING MILK - ALL GROUP - LINE C</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>MONTHLY - OEE FILLING MILK - ALL GROUP - LINE D</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
