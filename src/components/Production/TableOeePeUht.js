...
const INVENTORY_API_URLDB = `${API_HOST}/OeeUhtWP`;
// const INVENTORY_API_URLDC = `${API_HOST}/OeeChsPGPLC`;
// const INVENTORY_API_URLDD = `${API_HOST}/OeeChsPGPLD`;

const columns = [
  { id: 'Week', label: 'Week', minWidth: 20 },
  { id: 'NPT', label: 'Net Prod Time', minWidth: 20 },
  { id: 'OT', label: 'Operational Time', minWidth: 50 },
  { id: 'PE', label: 'PE', minWidth: 50 },
  { id: 'OE', label: 'OE', minWidth: 20 },
  { id: 'OE', label: 'OEE', minWidth: 20 },
];
