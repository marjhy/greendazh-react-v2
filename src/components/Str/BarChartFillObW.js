...
const BarChartFillObW = () => {
  const [chartDataLineFiO, setChartDataLineFiO] = useState({});

  // STR POUCHHART OEE STR STR 500/1000
  const lineChartFillOeeM = () => {
    ...
    axios
      .get('http://10.24.7.70:8080/OeeStrAGPLWBc')
      .then((res) => {
  ...
  const options = {
    responsive: true,
    title: {
      text: 'OPERATIONAL TIME STR 500/1000 BY WEEK',
      display: true,
      fontSize: 22,
...
export default BarChartFillObW;
