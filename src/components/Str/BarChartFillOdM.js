...
const BarChartFillObM = () => {
  ...
  const [title, setTitle] = useState(
    'OPERATIONAL TIME STR 125 BY MONTH ' + value
  );

  // LINE CHART OEE FILLING STR 125
  const lineChartFillOeeM = () => {
    ...
    axios
      .get(`http://10.24.7.70:8080/OeeStrAGPLMDc/${value}`)
      .then((res) => {
          ...
          <TextField   
           ...
           id='demo-simple-select-outlined2'
            ...
            onChange={(e) => {
              ...
              setValue(value);
              setTitle('OPERATIONAL TIME STR 125 BY MONTH ' + value);
            }}
            variant="outlined"
          /><br/>     
          </Grid> 
