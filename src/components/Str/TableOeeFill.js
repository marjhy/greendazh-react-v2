...
//http://localhost:8080/OeeStrPGPL
//const API_HOST2 = "http://10.24.7.70:8080";

//const INVENTORY_API_URL = `${API_HOST}/OeeStrPGPLB`;

const INVENTORY_API_URLDB = `${API_HOST}/OeeStrPGPLB`;
const INVENTORY_API_URLDC = `${API_HOST}/OeeStrPGPLC`;
const INVENTORY_API_URLDD = `${API_HOST}/OeeStrPGPLD`;

const INVENTORY_API_URLWB = `${API_HOST}/OeeStrPGPLWB`;
const INVENTORY_API_URLWC = `${API_HOST}/OeeStrPGPLWC`;
const INVENTORY_API_URLWD = `${API_HOST}/OeeStrPGPLWD`;

const INVENTORY_API_URLMB = `${API_HOST}/OeeStrPGPLMB`;
const INVENTORY_API_URLMC = `${API_HOST}/OeeStrPGPLMC`;
const INVENTORY_API_URLMD = `${API_HOST}/OeeStrPGPLMD`;
  ...
  return (
    <Container className='container'>
      <Paper className={classes.root}>
        <h1>DAILY - OEE STR - ALL GROUP - STR 500/1000</h1>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>DAILY - OEE STR - ALL GROUP - STR POUCH</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>DAILY - OEE STR - ALL GROUP - STR 125</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>WEEKLY - OEE STR - ALL GROUP - STR 500/1000</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>WEEKLY - OEE STR - ALL GROUP - STR POUCH</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>MONTHLY - OEE STR - ALL GROUP - STR 500/1000</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>MONTHLY - OEE STR - ALL GROUP - STR POUCH</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
      ...
      <br />
      <Paper className={classes.root}>
        <h1>MONTHLY - OEE STR - ALL GROUP - STR 125</h1>
        <TableContainer className={classes.container}>
          <Table stickyHeader aria-label='sticky table'>
            <TableHead>
              <TableRow>
